<template>
	<div class="addEdit-block">
		...
		>
			...
			<el-form-item class="textarea" v-if="type!='info'" label="领养申请" prop="lingyangshenqing" >
				<el-input
			...
			<el-form-item v-else-if="ruleForm.lingyangshenqing" label="领养申请" prop="lingyangshenqing" >
				<span class="text">{{ruleForm.lingyangshenqing}}</span>
			</el-form-item>
