	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item v-else class="input" label="宠物名称" prop="chongwumingcheng" >
				...
				<el-form-item class="input" v-if="type!='info'"  label="毛色" prop="maose" >
					<el-input v-model="ruleForm.maose" placeholder="毛色" clearable  :readonly="ro.maose"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="毛色" prop="maose" >
					<el-input v-model="ruleForm.maose" placeholder="毛色" readonly></el-input>
				</el-form-item>
				<el-form-item class="input" v-if="type!='info'"  label="疫苗记录" prop="yimiaojilu" >
					<el-input v-model="ruleForm.yimiaojilu" placeholder="疫苗记录" clearable  :readonly="ro.yimiaojilu"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="疫苗记录" prop="yimiaojilu" >
					<el-input v-model="ruleForm.yimiaojilu" placeholder="疫苗记录" readonly></el-input>
				</el-form-item>
				...
				<el-form-item class="input" v-if="type!='info'"  label="饮食习惯" prop="yinshixiguan" >
					<el-input v-model="ruleForm.yinshixiguan" placeholder="饮食习惯" clearable  :readonly="ro.yinshixiguan"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="饮食习惯" prop="yinshixiguan" >
					<el-input v-model="ruleForm.yinshixiguan" placeholder="饮食习惯" readonly></el-input>
				</el-form-item>
				<el-form-item class="input" v-if="type!='info'"  label="特殊营养需求" prop="teshuyingyangxuqiu" >
					<el-input v-model="ruleForm.teshuyingyangxuqiu" placeholder="特殊营养需求" clearable  :readonly="ro.teshuyingyangxuqiu"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="特殊营养需求" prop="teshuyingyangxuqiu" >
					<el-input v-model="ruleForm.teshuyingyangxuqiu" placeholder="特殊营养需求" readonly></el-input>
				</el-form-item>
				...
				<el-form-item class="select" v-if="type!='info'"  label="领养状态" prop="lingyangzhuangtai" >
					<el-select :disabled="ro.lingyangzhuangtai" v-model="ruleForm.lingyangzhuangtai" placeholder="请选择领养状态" >
						<el-option
							v-for="(item,index) in lingyangzhuangtaiOptions"
							v-bind:key="index"
							:label="item"
							:value="item">
						</el-option>
				...
				<el-form-item v-else class="input" label="领养状态" prop="lingyangzhuangtai" >
					<el-input v-model="ruleForm.lingyangzhuangtai"
			...
			<el-form-item v-else-if="ruleForm.chongwuxiangqing" label="宠物详情" prop="chongwuxiangqing" >
				<span class="text" v-html="ruleForm.chongwuxiangqing"></span>
			</el-form-item>
				...
				if(this.type=='info'||this.type=='else'){
					...
					for (var o in obj){
						...
						if(o=='lingyangzhuangtai'){
							this.ruleForm.lingyangzhuangtai = obj[o];
							this.ro.lingyangzhuangtai = true;
							continue;
						}
						if(o=='fabushijian'){
					...
					this.ruleForm.lingyangzhuangtai = '待领养'; 				}
				// 获取用户信息
				this.$http({
			...
			info(id) {
				this.$http({
					...
					if (data && data.code === 0) {
						...
						this.ruleForm.chongwuxiangqing = this.ruleForm.chongwuxiangqing.replace(reg,'../../../springbootio7q3t15/upload');
					} else {
						this.$message.error(data.msg);
					}
				});
