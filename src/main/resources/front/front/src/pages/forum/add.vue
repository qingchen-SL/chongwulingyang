<template>
	<div :style='{"width":"1200px","padding":"0px","margin":"20px auto","position":"relative","background":"rgb(255, 255, 255)"}'>
		<div class="section-title" :style='{"margin":"10px 0","color":"#333","textAlign":"center","background":"#f7db61","width":"100%","fontSize":"24px","lineHeight":"50px","border-bottom":"1px solid #1f292f"}'>交流论坛</div>
		<div class="back_box">
		...
		<el-form class="add-update-preview" :model="form" :rules="rules" ref="form" label-width="180px">
			...
			<el-form-item :style='{"padding":"0","margin":"20px 0"}'>
				<el-button :style='{"border":"0","cursor":"pointer","padding":"0 15px","margin":"0 20px 0 0","textAlign":"center","display":"inline-block","minWidth":"110px","borderRadius":"2px","background":"#f7db61","width":"auto","lineHeight":"40px","fontSize":"16px","height":"40px"}' type="primary" @click="submitForm('form')">
					<span class="icon iconfont icon-kaitongfuwu" :style='{"color":"#333"}'></span>
					<span class="text" :style='{"color":"#333"}'>{{this.isEdit ? '修改' : '发布帖子'}}</span>
				</el-button>
				<el-button :style='{"border":"1px solid #ddd","cursor":"pointer","padding":"0 15px","margin":"0 20px 0 0","textAlign":"center","display":"inline-block","minWidth":"110px","borderRadius":"2px","background":"#fff","width":"auto","lineHeight":"40px","fontSize":"16px","height":"40px"}' @click="resetForm('form')">
