<template>
	<div class="add-update-preview">
		<el-form
			...
			<el-form-item class="add-item" label="活动时间" prop="huodongshijian">
			...
			<el-form-item class="add-item" label="活动图片" v-if="type!='cross' || (type=='cross' && !ro.huodongtupian)" prop="huodongtupian">
				<file-upload
					tip="点击上传活动图片"
					action="file/upload"
					:limit="3"
			...
			<el-form-item class="add-item" v-else label="活动图片" prop="huodongtupian">
				<img v-if="ruleForm.huodongtupian.substring(0,4)=='http'" class="upload-img" v-bind:key="index" :src="ruleForm.huodongtupian.split(',')[0]">
				<img v-else class="upload-img" v-bind:key="index" v-for="(item,index) in ruleForm.huodongtupian.split(',')" :src="baseUrl+item">
			</el-form-item>
			<el-form-item class="add-item" label="活动内容" prop="huodongneirong">
