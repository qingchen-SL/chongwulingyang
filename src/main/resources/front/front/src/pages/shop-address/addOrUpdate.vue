<template>
	<div :style='{"padding":"0 0 20px","margin":"0px auto","color":"#666","background":"#fff","width":"1200px","fontSize":"16px","position":"relative"}'>
		<el-form class="add-update-preview" ref="form" :model="form" :rules="rules" label-width="180px">
			<el-form-item :style='{"border":"2px inset #f7db6150","padding":"10px","margin":"0 0 10px","background":"#f7db6110"}' label="联系人" prop="name">
				<el-input v-model="form.name" placeholder="联系人"></el-input>
			</el-form-item>
			<el-form-item :style='{"border":"2px inset #f7db6150","padding":"10px","margin":"0 0 10px","background":"#f7db6110"}' label="手机号码" prop="phone">
				<el-input v-model="form.phone" placeholder="手机号码"></el-input>
			</el-form-item>
			<el-form-item :style='{"border":"2px inset #f7db6150","padding":"10px","margin":"0 0 10px","background":"#f7db6110"}' label="默认地址">
				<el-radio-group v-model="form.isdefault">
					<el-radio label="是"></el-radio>
					<el-radio label="否"></el-radio>
				</el-radio-group>
			</el-form-item>
			<el-form-item :style='{"border":"2px inset #f7db6150","padding":"10px","margin":"0 0 10px","background":"#f7db6110"}' label="地址" prop="address">
