<template>
	<div class="add-update-preview">
		<el-form
			...
			label-width="180px"
			>
			<el-form-item class="add-item" label="领养标题" prop="jiuzhubiaoti">
				<el-input v-model="ruleForm.jiuzhubiaoti" 
					placeholder="领养标题" clearable :disabled=" false  ||ro.jiuzhubiaoti"></el-input>
			</el-form-item>
			<el-form-item class="add-item" label="宠物性别" prop="chongwuxingbie">
				<el-input v-model="ruleForm.chongwuxingbie" 
					placeholder="宠物性别" clearable :disabled=" false  ||ro.chongwuxingbie"></el-input>
			</el-form-item>
			...
			<el-form-item class="add-item" label="求助内容" prop="qiuzhuneirong">
				<el-input v-model="ruleForm.qiuzhuneirong" 
					placeholder="求助内容" clearable :disabled=" false  ||ro.qiuzhuneirong"></el-input>
			</el-form-item>
			<el-form-item class="add-item" label="领养地点" prop="jiuzhudidian">
				<el-input v-model="ruleForm.jiuzhudidian" 
					placeholder="领养地点" clearable :disabled=" false  ||ro.jiuzhudidian"></el-input>
			</el-form-item>
			...
			<el-form-item class="add-item" label="领养时间" prop="jiuzhushijian">
				<el-date-picker
					:disabled=" false  ||ro.jiuzhushijian"
			...
			<el-form-item class="add-item" label="志愿者账号" prop="zhiyuanzhezhanghao">
				<el-input v-model="ruleForm.zhiyuanzhezhanghao" 
					placeholder="志愿者账号" clearable :disabled="true  ||ro.zhiyuanzhezhanghao"></el-input>
			</el-form-item>
			<el-form-item class="add-item" label="志愿者姓名" prop="zhiyuanzhexingming">
				<el-input v-model="ruleForm.zhiyuanzhexingming" 
					placeholder="志愿者姓名" clearable :disabled="true  ||ro.zhiyuanzhexingming"></el-input>
			</el-form-item>
			<el-form-item class="add-item" label="领养记录" prop="jiuzhujilu">
				<el-input
					type="textarea"
					:rows="8"
					placeholder="领养记录"
...
<script>
	export default {
		...
		methods: {
			...
			// 多级联动参数
			info() {
				this.$http.get(`zhiyuanzhejiuzhu/detail/${this.$route.query.id}`, {emulateJSON: true}).then(res => {
					if (res.data.code == 0) {
			...
			async onSubmit() {
				await this.$refs["ruleForm"].validate(async valid => {
					if(valid) {
						...
						await this.$http.post(`zhiyuanzhejiuzhu/${this.ruleForm.id?'update':this.centerType?'save':'add'}`, this.ruleForm).then(async res => {
							if (res.data.code == 0) {
								this.$message({
									message: '操作成功',
									type: 'success',
